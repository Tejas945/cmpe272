...
<div class="main">
  <h1> Google Cardboard </h1>
    ...
    <p><img src="images/2_Google_cardboard.jpg" alt="Acer" style="width:170px; height: 170px; margin-right: 25px; border: solid black 1px; padding = 2px;">
    <b>Price:</b> 
    <div class="b">
...
<ul>
            ...
            <li>Works with your smartphone</li>
